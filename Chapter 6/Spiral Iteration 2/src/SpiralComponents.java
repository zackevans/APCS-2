	...
	// Function NOT needed just to plot points not drawn on screen!!
		...
		public void drawSpiral(Graphics g)
		{
			...
			for (int i =0; i<100;i++)
			{
				...
				System.out.println(myArray[i+M0]);
				System.out.println(myArray[i+M1]);
				System.out.println(myArray[i+M2]);
				System.out.println(myArray[i+M3]);
				
				g2.drawLine(myArray[i+M0],myArray[i+M1],myArray[i+M2],myArray[i+M3]);
